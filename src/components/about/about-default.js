...
const services = [
    {
        desc: "Lackluster Husband, above-average dad, unworthy deacon, Christmas podcaster, digital marketer.",
                    ...
                    <div className="cavani_tm_about">
                        <div className="biography">
                            ...
                            <div className="wrapper">
                                <div className="left">
                                    <p>Hey there, I&apos;m <strong>Thom Crowe.</strong>  A little about me, I was ordained a deacon in the Orthodox Church before joining the Anglican tradition, work in tech marketing marketing, am a dad to a sweet little girl and husband to a great wife who runs the <a href="https://shopatmade.com">Made Shop.</a> </p>
                                    <p>I’m an avid reader, beer aficionado, lover of theology and history, and aspiring coffee snob. We have a pretty happy life here Tulsa, OK.</p>
                                </div>
                                <div className="right">
                                    <ul>
                                        <li><span className="first">Name:</span><span className="second">Thom Crowe</span></li>
                                        <li><span className="first">From:</span><span className="second">Tulsa, OK</span></li>
                                        <li><span className="first">Degrees:</span><span className="second">English, PolySci, and Theology</span></li>
                                        <li><span className="first">Mail:</span><span className="second"><a href="#">thom@thomcrowe.com</a></span></li>
                                        <li><span className="first">Phone:</span><span className="second">+1 918.200.9220</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="services">
                            <div className="wrapper">
                                <div className="service_list">
                                    ...
                                    <div className="list">
                                        <ul>
                                            <li><a href="https://tisthepodcast.com/">Tis the Podcast</a></li>
                                            <li><a href="https://angloorthodoxy.com">Anglo-Orthodox</a></li>
                                            <li><a href="https://advent-stablo-pro.vercel.app/">Advent Reflections</a></li>
                                            <li><a href="http://ww1.antiochian.org/fatherhood-kind-asceticism">On Fatherhood</a></li>
                                            <li>Social Media</li>
                                        </ul>
                                    </div>
                                </div>
