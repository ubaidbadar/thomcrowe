                            ...
                            <ul>
                                ...
                                <li>
                                    <div className="list_inner">
                                        ...
                                        <span><a href="#">hello@thomcrowe.com</a></span>
                                    </div>
                                </li>
                                <li>
                                    <div className="list_inner">
                                        <i className="icon-mobile"></i>
                                        <span>+1 918.346.5014</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div className="fields">
                                    ...
                                    <form className="contact_form" onSubmit={(e) => onSubmit(e)}>
                                        <div
                                            ...
                                            data-success="Your message has been received and you'll hear from me soon."
                                ...
                                <div className="map_wrap">
                                    <div className="map" id="ieatmaps">
                                        <iframe
                                            ...
                                            style={{ width: "100%" }}
                                            id="gmap_canvas"
                                            src="https://maps.google.com/maps?q=219%20e%20archer,%20tulsa,%20OK&t=&z=15&ie=UTF8&iwloc=&output=embed"
                                        />
                                    </div>
                                </div>
