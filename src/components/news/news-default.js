...
export default function NewsDefault({ ActiveIndex }) {
    ...
    const news = [
        {
            ...
            text1: "After nearly 3 years of avoiding the Covid virus, our luck has turned and Christine, Ellie, and I are all at home sick. Unfortunatley, my mom and sister also caught it while here for the holiday.",
            text2: "Time to stay home, eat some soup, and rest, rest, rest. Wish us luck!"
        },
        {
    ...
    return (
        <>
            {/* <!-- NEWS --> */}
            <div className={ActiveIndex === 3 ? "cavani_tm_section active animated fadeInUp" : "cavani_tm_section hidden animated"} id="news_">
